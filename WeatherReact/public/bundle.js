	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        IndexLink,
	        { to: '/', activeClassName: 'active', activeStyle: { color: '#f00' } },
	        'Get Weather'
	      ),
	      React.createElement(
	        Link,
	        { to: '/about', activeClassName: 'active', activeStyle: { color: '#f00' } },
	        'About'
	      ),
	      React.createElement(
	        Link,
	        { to: '/examples', activeClassName: 'active', activeStyle: { color: '#f00' } },
	        'Examples'
	      )
	    );
	  }
	...
	var WeatherForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { ref: 'location', type: 'text', placeholder: 'Enter a city name' }),
	      React.createElement(
	        'button',
	        null,
	        'Get Weather'
